...
var levels = {
    ...
    3: {
            ...
            enemy: [
                ...
                // strom vlevo
                {id:"c2", x:40, y:460, axis:"x", speed:0.8, howMany:140, scale:0.9, texture:"gfx/dromebody.png", mask:"273.6,355.7 132.9,355.7 123.6,426.4 130,446.4 129.3,462.1 122.1,474.3 126.4,495 139.3,508.6 190,532.9 329.3,520"},
                // okno uprostred
                ...
                {id:"c5", x:725, y:315, axis:"x", speed:0.4, howMany:85, scale:0.3, texture:"gfx/drome.png", mask:"767.1,287.1 783.6,342.1 746.4,325.7 737.1,290.7"},
                // okno s muskaty
                {id:"c6", x:800, y:244, axis:"y", speed:-0.4, howMany:90, scale:0.25, texture:"gfx/drome.png", mask:"792.9,225 825.7,213.6 815,186.4 781.4,197.1"},
                // velka vrata
                {id:"c7", x:595, y:390, axis:"x", speed:0.4, howMany:80, scale:0.24, texture:"gfx/dromebody.png", mask:"619.3,350.7 627.9,419.3 662.9,420.7 653.6,361.4"},
                // komin napravo
                {id:"c8", x:920, y:88, axis:"x", speed:-0.5, howMany:90, scale:-0.35, texture:"gfx/drome.png", mask:"838.6,61 889.3,61.43 909.3,104.3 855.7,128.6"},
                // strecha napravo 
                ...
                // strecha nad oknem
                {id:"c10", x:600, y:200, axis:"y", speed:-0.4, howMany:110, scale:-0.28, texture:"gfx/drome.png", mask:"626.4,112.9 632.1,151.4 580,187.9 575.7,145.7"},
                // roh domu uprostred zleva
                {id:"c11", x:460, y:395, axis:"x", speed:0.4, howMany:110, scale:0.2, texture:"gfx/dromebody.png", mask:"502.9,369.3 503.6,422.9 547.9,424.3 545.7,367.1"},
                // zespodu dole vpravo
