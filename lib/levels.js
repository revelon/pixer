...
var levels = {
    1: {
            ...
            intro: {x:400, y:319, scale:1, texture:"gfx/sheep.png", name:"sheeps"},
            ...
            enemy: [
                ...
                // zed vpravo zboku
                {id:"a4", x:658, y:348, axis:"x", speed:-0.8, howMany:75, scale:0.3, rotate:-0.2, texture:"gfx/sheep.png", mask:"622.14286,303.92857 631.42857,361.07143 638.21429,366.42857 631.42857,372.85714 631.07143,384.64286 560,388.57143 560,308"},
                // kanal
                {id:"a5", x:352, y:530, axis:"y", speed:-0.7, howMany:85, scale:0.25, texture:"gfx/sheep.png", mask:"318.21429,487.14286 321.42857,492.5 338.92857,494.28571 356.78571,493.21429 373.92857,489.64286 383.21429,485 383.92857,479.28571 387.85714,424.64286 295.71429,425.35714"},
                // okno nade dvermi
                ...
                // okno v kulate vezi
                {id:"a7", x:492, y:257, axis:"x", speed:-0.4, howMany:50, scale:0.1, texture:"gfx/sheep.png", mask:"462.85714,239.64286 464.28571,266.07143 481.07143,265.71429 477.85714,239.64286"},
                ...
                // zed vlevo zboku
                {id:"a10", x:170, y:390, axis:"x", speed:0.46, howMany:110, scale:0.21, rotate:0.1, texture:"gfx/sheep.png", mask:"202.5,359.28571 195.71429,415.71429 240,415 251.42857,342.85714"},
                // okno vlevo nahore
                {id:"a11", x:165, y:235, axis:"x", speed:0.28, howMany:90, scale:0.15, rotate:0.5, texture:"gfx/sheep.png", mask:"186.07143,203.21429 178.92857,246.42857 208.92857,249.64286 221.07143,205"},
                // okno vlevo dole
                ...
                // zespodu dole
                {id:"a14", x:520, y:680, axis:"y", speed:-3.2, howMany:72, scale:1.2, texture:"gfx/sheep.png", mask:""},
                // zboku zprava
                {id:"d15", x:1150, y:300, axis:"x", speed:-3.2, howMany:80, scale:1.3, rotate:-1.2, texture:"gfx/sheep.png", mask:""},
    ...
    2: {
            ...
            intro: {x:400, y:295, scale:1, texture:"gfx/squirrel.png", name:"squirrels"},
            ...
            enemy: [
                ...
                // 2. strom zleva
                {id:"d4", x:190, y:426, axis:"x", speed:0.6, howMany:90, scale:-0.4, rotate:0.2, texture:"gfx/squirrel.png", mask:"231.42857,315.71429 227.85714,379.28571 230.71429,432.14286 231.42857,464.28571 270,455 275,426.42857 273.57143,355.71429 270.71429,316.42857"},
                ...
                // 5. strom zprava
                {id:"d9", x:725, y:400, axis:"x", speed:-0.5, howMany:90, scale:0.25, rotate:-0.2, texture:"gfx/squirrel.png", mask:"693.57143,356.42857 695.71429,425.71429 681.42857,436.42857 601.42857,441.42857 600.71429,360"},
                // 2. strom zprava
                ...
                // 3. strom zleva vetve
                {id:"d13", x:295, y:315, axis:"x", speed:0.46, howMany:90, scale:-0.28, rotate:0.6, texture:"gfx/squirrel.png", mask:"310.71429,272.14286 325,308.57143 325.71429,321.42857 319.28571,349.28571 388.57143,345.71429 380.71429,257.14286 345,263.57143"},
                // zhora
                {id:"d14", x:570, y:-110, axis:"y", speed:2.2, howMany:80, scale:1, rotate:3.2, texture:"gfx/squirrel.png", mask:""},
                // zdola
                {id:"d15", x:350, y:640, axis:"y", speed:-2.2, howMany:80, scale:1, texture:"gfx/squirrel.png", mask:""}
            ]
        },
    3: {
            enemiesNo: 15,
            poster: "background/vaison-la-romaine2.jpg",
            intro: {x:380, y:308, scale:1.2, texture:"gfx/dromebody.png", name:"camels"},
            sfx: ["sfx/57181__erdie__camel.mp3", "sfx/61605__andune__schnauf.mp3"],
            dieStyle: true,
            enemy: [
                // kasna dole 
                {id:"c1", x:140, y:520, axis:"x", speed:1.2, howMany:90, scale:0.5, rotate:0.0, texture:"gfx/dromebody.png", mask:"314.3,455 229.3,463.6 229.3,497.9 195,502.1 192.9,533.6 322.9,567.1"},
                // strom vlevo
                {id:"c2", x:5, y:470, axis:"x", speed:1, howMany:120, scale:1, rotate:0.0, texture:"gfx/dromebody.png", mask:"273.6,355.7 132.9,355.7 123.6,426.4 130,446.4 129.3,462.1 122.1,474.3 126.4,495 139.3,508.6 190,532.9 329.3,520"},
                // okno uprostred
                ...
                // komin napravo
                {id:"c8", x:920, y:90, axis:"x", speed:-0.4, howMany:90, scale:-0.35, rotate:-0.2, texture:"gfx/drome.png", mask:"838.6,61 889.3,61.43 909.3,104.3 855.7,128.6"},
                // strecha napravo 
                ...
                // zespodu dole vpravo
                {id:"c12", x:1054, y:435, axis:"x", speed:-1.5, howMany:115, scale:-1.5, rotate:0, texture:"gfx/drome.png", mask:""},
                // zespodu
                {id:"c13", x:450, y:740, axis:"y", speed:-3.15, howMany:70, scale:-1.5, rotate:0.2, texture:"gfx/dromebody.png", mask:""}
    ...
    4: {
            ...
            intro: {x:380, y:294, scale:0.7, texture:"gfx/rabbit.png", name:"rabbits"},
            ...
            enemy: [
                ...
                {id:"b3", x:310, y:324, axis:"x", speed:-0.3, howMany:96, scale:0.1, rotate:0.2, texture:"gfx/rabbit.png", mask:"287.9,343.2 288.2,332.1 282.5,331.8 282.5,326.8 290,326.4 289.6,315.7 283.6,315.7 283.9,311.4 288.9,311.1 288.9,300 251.1,299.6 250,343.6"},
                // sloup dole na brehu
                {id:"b4", x:290, y:454, axis:"x", speed:-0.2, howMany:170, scale:0.1, rotate:0.15, texture:"gfx/rabbit.png", mask:"272.1,473.6 271.8,438.6 227.1,437.5 227.9,475"},
                // horni oblouk uplne vlevo
                {id:"b5", x:390, y:190, axis:"x", speed:-0.22, howMany:110, scale:0.1, rotate:0.1, texture:"gfx/rabbit.png", mask:"354.3,202.1 373.6,202.1 375,196.4 374.6,192.5 368.9,188.9 368.9,186.8 373.6,186.1 373.2,175.4 370,166.8 345.7,167.1 345,201.4"},
                // horni oblouk stredni vlevo
                {id:"b6", x:520, y:173, axis:"x", speed:-0.35, howMany:90, scale:0.12, rotate:0.1, texture:"gfx/rabbit.png", mask:"451.4,140.4 495,141.1 501.1,150.7 503.6,164.6 504.3,169.3 498.9,169.3 498.2,172.1 504.6,178.6 504.6,189.6 446.4,193.6"},
                // horni oblouk stredni vpravo
                {id:"b7", x:688, y:157, axis:"x", speed:-0.5, howMany:115, scale:0.15, rotate:0.1, texture:"gfx/rabbit.png", mask:"660.7,177.5 661.1,160.4 655,153.6 661.4,148.9 660.4,128.9 658.2,128.2 646.1,110.4 577.9,109.6 575,184.6"},
                // horni oblouk vpravo
                ...
                // horni obruba vlevo
                {id:"b10", x:370, y:150, axis:"y", speed:-0.4, howMany:100, scale:0.1, rotate:-0.15, texture:"gfx/rabbit.png", mask:"353.9,92.5 400.7,74.29 404.3,107.9 354.3,128.2"},
                // stredni oblouk vprostred na druhou stranu vlevo 
                {id:"b11", x:375, y:368, axis:"x", speed:0.35, howMany:110, scale:-0.1, rotate:-0.2, texture:"gfx/rabbit.png", mask:"400.7,320 399.6,359.3 407.1,361.1 407.1,363.2 400.7,365.7 399.6,386.1 436.8,384.6 436.1,363.6 429.6,358.6 437.1,355.4 436.8,338.2 432.5,334.3 437.1,330 436.1,322.5 427.5,318.9"},
                // stredni oblouk vprostred na druhou stranu vpravo
                {id:"b12", x:500, y:440, axis:"x", speed:0.45, howMany:100, scale:-0.13, rotate:-0.3, texture:"gfx/rabbit.png", mask:"525.7,400 526.4,461.8 588.2,458.9 586.4,398.6"},
                // zespodu dole vlevo
                {id:"b13", x:90, y:710, axis:"y", speed:-3.5, howMany:90, scale:-1, texture:"gfx/rabbit.png", mask:""},
                // zespodu vpravo...
                {id:"b14", x:1160, y:422, axis:"x", speed:-3.5, howMany:95, scale:1, texture:"gfx/rabbit.png", mask:""},
            ]
        }
};
