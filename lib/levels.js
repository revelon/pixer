...
var levels = {
    ...
    2: {
            ...
            sfx: ["sfx/41528__jamius__pig.mp3", "sfx/7737__noisecollector__pigtoy.mp3"],
            enemy: [
    ...
    4: {
            ...
            enemy: [
                // 1. strom zleva
                {id:"d1", x:10, y:400, axis:"x", speed:0.8, howMany:100, scale:-0.66, rotate:0, texture:"gfx/squirrel.png", mask:"170.714,306.429 170,446.429 87.8571,487.143 68.5714,437.857 59.2857,304.286"},
                // 2. strom zleva druha strana (same)
                {id:"d2", x:220, y:390, axis:"x", speed:-0.8, howMany:90, scale:0.5, rotate:0, texture:"gfx/squirrel.png", mask:"170.714,306.429 170,446.429 87.8571,487.143 68.5714,437.857 59.2857,304.286"},
                // 2. strom zleva vetev
                {id:"d3", x:150, y:100, axis:"x", speed:-0.6, howMany:90, scale:0.4, rotate:-0.3, texture:"gfx/squirrel.png", mask:"93.5714,56.4286 120,121.429 108.571,158.571 34.2857,155.714 32.1429,56.4286"},
                // 2. strom zleva
                {id:"d4", x:190, y:420, axis:"x", speed:0.6, howMany:90, scale:-0.4, rotate:0, texture:"gfx/squirrel.png", mask:"231.42857,315.71429 227.85714,379.28571 230.71429,432.14286 231.42857,464.28571 270,455 275,426.42857 273.57143,355.71429 270.71429,316.42857"},
                // 3. strom zleva druha strana (same)
                {id:"d5", x:310, y:400, axis:"x", speed:-0.5, howMany:90, scale:0.4, rotate:0, texture:"gfx/squirrel.png", mask:"231.42857,315.71429 227.85714,379.28571 230.71429,432.14286 231.42857,464.28571 270,455 275,426.42857 273.57143,355.71429 270.71429,316.42857"},
                // 5. strom zleva
                {id:"d6", x:390, y:415, axis:"x", speed:0.6, howMany:90, scale:-0.3, rotate:0, texture:"gfx/squirrel.png", mask:"415,365.71429 416.42857,402.85714 415,442.85714 495.71429,445 492.14286,360"},
                // 6. strom zleva vetve
                {id:"d7", x:405, y:160, axis:"x", speed:0.45, howMany:70, scale:-0.25, rotate:0, texture:"gfx/squirrel.png", mask:"422.85714,120 427.14286,153.57143 432.85714,189.28571 471.42857,182.85714 467.14286,119.28571"},
                // 2. strom zprava vetve
                {id:"d8", x:800, y:40, axis:"x", speed:-0.7, howMany:80, scale:0.5, rotate:0, texture:"gfx/squirrel.png", mask:"735,3.5714289 746.42857,48.571429 764.28571,87.857143 655,116.42857 620.71429,3.5714289"},
                // 5. strom zprava
                {id:"d9", x:720, y:400, axis:"x", speed:-0.5, howMany:90, scale:0.25, rotate:0, texture:"gfx/squirrel.png", mask:"693.57143,356.42857 695.71429,425.71429 681.42857,436.42857 601.42857,441.42857 600.71429,360"},
                // 2. strom zprava
                {id:"d10", x:800, y:410, axis:"x", speed:-0.6, howMany:90, scale:0.4, rotate:0, texture:"gfx/squirrel.png", mask:"760,272.85714 768.57143,305 775.71429,432.85714 765,455.71429 662.85714,466.42857 652.14286,267.14286"},
                // 1. strom zprava
                ...
                {id:"d12", x:870, y:130, axis:"x", speed:-0.66, howMany:96, scale:0.45, rotate:0, texture:"gfx/squirrel.png", mask:"822.143,77.1429 834.286,110 817.857,170 711.429,212.857 718.571,62.8571"},
                // 3. strom zleva vetve
                {id:"d13", x:400, y:150, axis:"x", speed:0.4, howMany:90, scale:-0.22, rotate:0, texture:"gfx/squirrel.png", mask:"310.71429,272.14286 325,308.57143 325.71429,321.42857 319.28571,349.28571 388.57143,345.71429 380.71429,257.14286 345,263.57143"},
                // 
